...
app.post('/register',function(req,res){
	 ...
	 db.insert({_id : docId, "fullName" : FullName,"email" : Email, "password" : Password, " confirmPassword" : ConfirmPassword,"ServiceType" : ServiceType,"addr": Address, "city" : City, "Pincode" : PINcode, "PhoneNumber" : PhoneNumber},function(err,data){
		 if(err){
			 return err
		 }
		 //console.log(data);
