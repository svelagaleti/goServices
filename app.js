...
app.post('/register',function(req,res){
	 ...
	 var db = cloudant.db.use('userregister');
	 db.insert({_id : docId, "fullName" : FullName,"email" : Email, "password" : Password, " confirmPassword" : ConfirmPassword, "addr": Address, "city" : City, "Pincode" : PINcode, "PhoneNumber" : PhoneNumber},function(err,data){
		 if(err){
			 return err
		 }
		 //console.log(data);
